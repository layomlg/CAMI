...
class PDOSQLServer{
	...
	*/
	...
	function __construct($bd_host, $bd_user, $bd_password, $bd_data_base){
		try {
			$this->connection = new PDO("sqlsrv:Server=$bd_host;Database=$bd_data_base", $bd_user, $bd_password);
			$this->connection->setAttribute( PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION );
		} catch ( PDOException $e ){
			die( 'Could not connect to '.$bd_host.' sql server '.$e );
		} 
	}
