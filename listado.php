  ...
  require_once("views/layout/header.php");    
    ...
    <div class="contenedor">
      ...
      <div class="cuerpo">
        ...
        <div class="bloque">
          <iframe src="http://elearningtools.us/cp6/harmony/html5/Introduction%20to%20Harmony%20700/index.html" frameborder="0">
          </iframe>
        </div>
        <div class="bloque">
          <iframe src="http://captivate.layator.com/" frameborder="0">
          </iframe>
        </div>
      </div>
    </div>
